            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Edit Modul: {{ $module->title }}
                        </h3>
                    </div>
                    <form action="{{ route('admin.modules.update', $module) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="title" class="block mt-1 w-full" type="text" name="title"
                                :value="old('title', $module->title)" required autofocus />
                        ...
                        <div class="mb-4">
                            ...
                            <x-textarea-input id="description" class="block mt-1 w-full"
                                name="description">{{ old('description', $module->description) }}</x-textarea-input>
