<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Manajemen Pertanyaan untuk Kuis: ') }} {{ $quiz->title }}
        </h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                        ...
                        <a href="{{ route('admin.modules.quizzes.questions.create', [$module, $quiz]) }}"
                        ...
                        <table class="w-full text-left border-separate border-spacing-y-2">
                            <thead>
                                <tr class="text-gray-500 dark:text-gray-400 text-sm uppercase tracking-wider">
                                    ...
                                    <th class="px-6 py-3 font-bold">Teks Pertanyaan</th>
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            @if($question->description)
                                                <div class="text-xs text-gray-500 truncate max-w-xs">
                                                    {{ Str::limit($question->description, 50) }}</div>
                                            @endif
                                        </td>
                                        <td class="px-6 py-4 text-right rounded-r-2xl">
                                            <div class="flex justify-end gap-2">
                                                ...
                                                <a href="{{ route('admin.modules.quizzes.questions.edit', [$module, $quiz, $question]) }}"
                                                ...
                                                <form
                                                    action="{{ route('admin.modules.quizzes.questions.destroy', [$module, $quiz, $question]) }}"
                                                    method="POST"
