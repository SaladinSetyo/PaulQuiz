<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Manajemen Kuis untuk Modul: ') }} {{ $module->title }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                        <div class="flex items-center gap-4">
                            ...
                            <h3 class="text-2xl font-bold text-gray-900 dark:text-white">Daftar Kuis</h3>
                        </div>
                        <a href="{{ route('admin.modules.quizzes.create', $module) }}"
                                    ...
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-right rounded-r-2xl">
                                            <div class="flex justify-end gap-2">
                                                ...
                                                <a href="{{ route('admin.modules.quizzes.edit', [$module, $quiz]) }}"
                                                ...
                                                <form
                                                    action="{{ route('admin.modules.quizzes.destroy', [$module, $quiz]) }}"
                                                    method="POST"
