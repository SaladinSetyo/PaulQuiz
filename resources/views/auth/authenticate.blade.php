...
<body class="font-sans antialiased bg-gray-100 dark:bg-dark-900 text-gray-900 dark:text-white">
    ...
    <div x-data="{ 
        ...
        class="min-h-screen w-full flex items-center justify-center bg-slate-900 p-4 selection:bg-primary-500 selection:text-white relative overflow-hidden">
        ...
        <!-- Centered Card -->
        <div class="relative w-full max-w-5xl bg-slate-800 rounded-3xl shadow-2xl overflow-hidden border border-white/10"
            style="height: 650px;">

            <!-- Forms Container -->
            <div class="absolute inset-0 w-full h-full">
                <!-- Login Form (Left Side - Visible when Slider is on Right) -->
                <div class="absolute top-0 left-0 w-full md:w-[50%] h-full flex items-center justify-center p-8 transition-all duration-700 ease-in-out"
                    ...
                    <div class="w-full max-w-sm space-y-6">
                        ...
                        <div class="text-center">
                            ...
                            <p class="mt-2 text-slate-400 text-sm">Masuk untuk melanjutkan pembelajaran finansial Anda.
                            </p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('login') }}" class="space-y-4">
                            ...
                            <div>
                                ...
                                <x-text-input id="login_email"
                                    class="block mt-1 w-full rounded-xl bg-slate-700/50 border-slate-600 text-white focus:ring-primary-500 focus:border-primary-500 placeholder-slate-500"
                            ...
                            <div class="flex items-center justify-between mt-4">
                                <label for="remember_me" class="inline-flex items-center">
                                    <input id="remember_me" type="checkbox"
                                        class="rounded bg-slate-700 border-slate-600 text-primary-600 shadow-sm focus:ring-primary-500"
                                        name="remember">
                            ...
                            <x-primary-button
                                class="w-full justify-center py-3.5 text-base rounded-xl mt-6 font-bold shadow-lg shadow-primary-900/20 hover:shadow-primary-900/40 transition-all hover:scale-[1.02]">
                                {{ __('Masuk Sekarang') }}
                            </x-primary-button>
                        </form>
                ...
                <!-- Register Form (Right Side - Visible when Slider is on Left) -->
                <div class="absolute top-0 right-0 w-full md:w-[50%] h-full flex items-center justify-center p-8 transition-all duration-700 ease-in-out"
                    :class="!isRegister ? 'opacity-0 pointer-events-none translate-x-20' : 'opacity-100 translate-x-0'">
                    <div class="w-full max-w-sm space-y-6">
                        <div class="text-center md:hidden pb-6">
                            <x-application-logo class="h-12 w-auto fill-current text-primary-600 mx-auto" />
                        ...
                        <div class="text-center">
                            ...
                            <p class="mt-2 text-slate-400 text-sm">Bergabunglah dengan komunitas literasi finansial.</p>
                        </div>
            ...
            <div class="auth-slider absolute top-0 h-full bg-gradient-to-br from-primary-600 via-primary-700 to-indigo-900 transition-all duration-700 ease-in-out z-50 items-center justify-center overflow-hidden"
                ...
                :style="isRegister ? 'left: 0; border-top-right-radius: 3rem; border-bottom-right-radius: 3rem;' : 'left: 50%; border-top-left-radius: 3rem; border-bottom-left-radius: 3rem;'">
