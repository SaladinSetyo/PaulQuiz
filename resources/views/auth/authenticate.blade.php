...
<body class="font-sans antialiased bg-gray-100 dark:bg-dark-900 text-gray-900 dark:text-white">
    ...
    <body>
        <style>
            ...
            /* Form Reveal Speed & Easing */
            .form-container {
                opacity: 0;
                pointer-events: none;
                transition: all 2.5s cubic-bezier(0.85, 0, 0.15, 1);
                /* Matched to slider */
            }
            ...
            /* Slider Speed & Easing */
            #auth-slider-overlay {
                transition: all 2.5s cubic-bezier(0.85, 0, 0.15, 1) !important;
            }
        ...
        toggle() { this.isRegister = !this.isRegister; }
            ...
            <div class="relative w-full overflow-hidden flex bg-[#0B1120]"
                ...
                <div id="auth-slider-overlay"
                    class="auth-slider absolute top-0 h-full z-20 items-center justify-center overflow-hidden"
