<!-- MODALS - POSITIONED OUTSIDE GRID FOR PROPER Z-INDEX -->

<!-- RESULT POPUP - COMPLETELY SOLID, NO OVERLAP -->
<div x-show="showResult" style="display: none;" class="fixed inset-0 z-[9999] flex items-center justify-center"
    x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-90"
    x-transition:enter-end="opacity-100 scale-100">

    <!-- 100% SOLID BLACK BACKDROP -->
    <div class="absolute inset-0 bg-black" @click="showResult = false"></div>

    <!-- MODAL CONTENT -->
    <div class="relative bg-[#0B0E11] p-8 rounded-xl border-3 text-center shadow-2xl max-w-md w-full mx-4 z-10
                transform transition-all duration-300" :class="lastWin ? 'border-[#25A764]' : 'border-[#E53E3E]'">
...
<!-- GAME OVER MODAL - COMPLETELY SOLID -->
<div x-show="showGameOverModal" style="display: none;" class="fixed inset-0 z-[9998] flex items-center justify-center"
    ...
    <div
        ...
        <div class="bg-[#0b0e11] p-4 rounded-xl border border-[#2b3139] mb-6 space-y-2">
            ...
            <div class="flex justify-between text-sm border-t border-[#2b3139] pt-2">
                <span class="text-slate-500 font-bold">Total Profit:</span>
                <span class="font-mono font-bold" :class="totalProfit >= 0 ? 'text-emerald-400' : 'text-[#f6465d]'"
