...
<body id="top"
    ...
    <div class="flex flex-col min-h-screen">
            ...
            <section class="py-16 relative z-40 -mt-20 sm:-mt-24">
                <div class="max-w-3xl mx-auto px-4">
                    <div class="relative group">
                        ...
                        <div class="absolute -inset-2 bg-emerald-500/30 rounded-full blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                        <div class="absolute -inset-10 bg-emerald-600/20 rounded-full blur-3xl opacity-0 group-hover:opacity-70 transition-opacity duration-1000"></div>
                        ...
                        <div class="relative bg-white/10 dark:bg-white/[0.03] backdrop-blur-3xl rounded-full border border-white/30 dark:border-white/10 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.2)] p-4 px-10 flex items-center justify-between gap-8 transition-all duration-700 hover:scale-[1.01] hover:bg-white/20 dark:hover:bg-white/[0.05] overflow-hidden group/capsule neon-capsule-target">
                            ...
                            <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1500 ease-in-out"></div>
                            
                            <!-- Pure Internal Emerald Aura -->
                            <div class="absolute inset-0 bg-emerald-600/[0.03] opacity-0 group-hover/capsule:opacity-100 transition-opacity duration-700"></div>

                            <!-- Left Content: Logo -->
                            <div class="flex-shrink-0 relative group/logo">
                                <div class="absolute inset-0 bg-primary-500/20 rounded-full blur-2xl opacity-0 group-hover/logo:opacity-100 transition-opacity duration-700"></div>
                                <x-application-logo class="relative z-10 w-14 h-14 fill-current text-primary-600 dark:text-primary-400 drop-shadow-xl transform group-hover/logo:scale-110 transition-transform duration-500" />
                            </div>

                            <!-- Center Content: Info -->
                            <div class="flex-grow min-w-0 px-4">
                                <div class="flex items-center gap-3 mb-1.5">
                                    <div class="flex items-center gap-1.5 px-2.5 py-0.5 bg-emerald-500/10 rounded-full border border-emerald-500/20">
                                        <div class="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse"></div>
                                        <span class="text-[10px] font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400">Rekomendasi</span>
                                    </div>
                                    <span class="text-gray-400 dark:text-gray-500 text-[10px] font-bold uppercase tracking-[0.2em] hidden md:inline-block">{{ $featuredQuiz->module->title ?? 'Edukasi' }}</span>
                                </div>
                                <h3 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white truncate tracking-tight">
                                    {{ $featuredQuiz->title }}
                                </h3>
                            </div>
                            ...
                            <div class="flex-shrink-0">
                                @if(Auth::check() && $isFeaturedQuizSolved)
                                    <div class="flex flex-col items-end gap-3">
                                        <div class="flex items-center gap-2 px-4 py-2 bg-emerald-500/20 border border-emerald-500/30 rounded-xl">
                                            ...
                                            <span class="text-emerald-400 font-bold text-xs uppercase tracking-wider">Anda sudah mengerjakannya</span>
                                        </div>
                                ...
                                @else
                                    <a href="{{ route('quizzes.show', $featuredQuiz->quiz_id) }}" 
                                        ...
                                        <svg class="w-4 h-4 ml-3 relative z-10 transform group-hover/btn:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                                        </svg>
                                        
                                        <!-- Advanced Liquid Shimmer -->
                                        <div class="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-full group-hover/btn:translate-x-full transition-transform duration-1000 ease-in-out"></div>
                                        
                                        <!-- Subtle Inner Glow Ring -->
                                        <div class="absolute inset-[1px] rounded-full border border-white/10 pointer-events-none"></div>
                                    </a>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="flex items-center -space-x-4 overflow-x-auto py-6 px-4 [&::-webkit-scrollbar]:hidden" style="scrollbar-width: none; -ms-overflow-style: none;">
                                @foreach($onlineUsers as $user)
                                    <div class="relative group/avatar" title="{{ $user->name }}">
                                        ...
                                        <!-- Tooltip -->
                                        <div class="absolute -bottom-10 left-1/2 -translate-x-1/2 bg-emerald-600 text-white text-[10px] font-bold px-3 py-1.5 rounded-full opacity-0 group-hover/avatar:opacity-100 transition-all duration-300 whitespace-nowrap pointer-events-none shadow-lg shadow-emerald-500/20 translate-y-2 group-hover/avatar:translate-y-0 z-30">
                                            {{ $user->name }}
                                        </div>
                                    </div>
                                @endforeach
                        ...
                        @foreach($infographics as $infographic)
                            <a href="{{ $infographic->media_url }}" target="_blank"
                                ...
                                <div
                                    ...
                                    <h4 class="text-white font-bold text-lg mb-1 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-75">{{ $infographic->title }}</h4>
                                    <p class="text-gray-300 text-xs line-clamp-2 mb-4 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-100">{{ $infographic->description }}</p>
                                    <div class="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-300 delay-150">
                                        <span class="text-white font-bold text-[10px] bg-primary-600 px-4 py-1.5 rounded-full uppercase tracking-widest flex items-center w-fit">
                                            Buka Preview
                                            <svg class="w-3 h-3 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"></path></svg>
                                        </span>
                                    </div>
                                </div>
                            </a>
            ...
            <section id="about" class="py-24 bg-slate-50 dark:bg-dark-900 overflow-hidden relative">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div class="grid lg:grid-cols-2 gap-16 items-center">
                        <div class="relative">
                            <div class="absolute -top-12 -left-12 w-64 h-64 bg-primary-500/10 rounded-full blur-3xl"></div>
                            <div class="relative rounded-3xl overflow-hidden shadow-2xl bg-white dark:bg-dark-800 p-12 flex items-center justify-center min-h-[400px]">
                                ...
                                <div class="absolute bottom-8 left-8 right-8 p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20">
                                    <p class="text-gray-900 dark:text-white text-lg font-medium italic text-center">"Menciptakan generasi yang cerdas finansial di era digital."</p>
                                </div>
                            </div>
                        </div>

                        <div>
                            <span class="inline-block px-4 py-1 rounded-full bg-primary-100 dark:bg-primary-900/30 text-primary-600 dark:text-primary-400 text-xs font-bold uppercase tracking-widest mb-6">Tentang Paul Quiz</span>
                            <h2 class="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-8 leading-tight">
                                Transformasi Edukasi <span class="text-primary-600">Fintech</span> di Indonesia
                            </h2>
                            <p class="text-lg text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
                                Paul Quiz hadir sebagai platform edukasi interaktif yang dirancang khusus untuk membantu Anda memahami dunia teknologi finansial (Fintech) dengan cara yang menyenangkan dan mudah dipahami.
                            </p>
                            <div class="space-y-6">
                                <div class="flex items-start">
                                    <div class="flex-shrink-0 w-12 h-12 rounded-2xl bg-white dark:bg-dark-800 shadow-lg flex items-center justify-center text-primary-600">
                                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                    </div>
                                    <div class="ml-4">
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white">Kurikulum Terupdate</h4>
                                        <p class="text-gray-500">Materi yang selalu relevan dengan perkembangan industri terkini.</p>
                                    </div>
                                </div>
                                <div class="flex items-start">
                                    <div class="flex-shrink-0 w-12 h-12 rounded-2xl bg-white dark:bg-dark-800 shadow-lg flex items-center justify-center text-primary-600">
                                    ...
                                    <div class="ml-4">
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white">Interaktif & Menyenangkan</h4>
                                        <p class="text-gray-500">Belajar melalui video, infografis, dan kuis yang mengasyikkan.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section id="contact" class="py-24 bg-white dark:bg-dark-800">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center max-w-3xl mx-auto mb-16">
                        <span class="inline-block px-4 py-1 rounded-full bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400 text-xs font-bold uppercase tracking-widest mb-4">Hubungi Kami</span>
                        <h2 class="text-4xl font-extrabold text-gray-900 dark:text-white mb-6">Punya Pertanyaan?</h2>
                        <p class="text-lg text-gray-600 dark:text-gray-400 italic font-medium">Bekerjasama untuk masa depan ekonomi digital yang lebih baik.</p>
                    </div>

                    <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <!-- Contact Card 1 -->
                        <div class="p-8 rounded-3xl bg-slate-50 dark:bg-dark-900 border border-slate-100 dark:border-white/5 hover:border-primary-500 transition-all duration-300 group hover:shadow-xl hover:-translate-y-2">
                            <div class="w-14 h-14 bg-white dark:bg-dark-800 rounded-2xl shadow-lg flex items-center justify-center text-primary-600 mb-6 group-hover:scale-110 transition-transform">
                        ...
                        <!-- Contact Card 2 -->
                        <div class="p-8 rounded-3xl bg-slate-50 dark:bg-dark-900 border border-slate-100 dark:border-white/5 hover:border-primary-500 transition-all duration-300 group hover:shadow-xl hover:-translate-y-2">
                            <div class="w-14 h-14 bg-white dark:bg-dark-800 rounded-2xl shadow-lg flex items-center justify-center text-emerald-600 mb-6 group-hover:scale-110 transition-transform">
                                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 002-2H8a2 2 0 00-2 2v14a2 2 0 002 2z"></path></svg>
                            </div>
                            ...
                            <a href="https://wa.me/+6289669720953" class="text-emerald-600 font-bold hover:underline">+62 896 6972 0953</a>
                        </div>

                        <!-- Contact Card 3 -->
                        <div class="p-8 rounded-3xl bg-slate-50 dark:bg-dark-900 border border-slate-100 dark:border-white/5 hover:border-primary-500 transition-all duration-300 group hover:shadow-xl hover:-translate-y-2">
                            <div class="w-14 h-14 bg-white dark:bg-dark-800 rounded-2xl shadow-lg flex items-center justify-center text-blue-600 mb-6 group-hover:scale-110 transition-transform">
                        ...
                        <!-- Contact Card 4 -->
                        <div class="p-8 rounded-3xl bg-slate-50 dark:bg-dark-900 border border-slate-100 dark:border-white/5 hover:border-primary-500 transition-all duration-300 group hover:shadow-xl hover:-translate-y-2">
                            <div class="w-14 h-14 bg-white dark:bg-dark-800 rounded-2xl shadow-lg flex items-center justify-center text-pink-600 mb-6 group-hover:scale-110 transition-transform">
                                <svg class="w-7 h-7" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.266.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069v-2.163zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                            </div>
        ...
        <footer class="bg-slate-900 text-white py-16 relative overflow-hidden">
            <div class="absolute top-0 right-0 -translate-y-1/2 translate-x-1/4 w-96 h-96 bg-primary-500/10 rounded-full blur-3xl"></div>
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div class="grid md:grid-cols-3 gap-12 mb-12 border-b border-white/10 pb-12">
                    <div>
                        <div class="flex items-center mb-8 group">
                            <div class="relative w-24 h-24 md:w-28 md:h-28 mr-6 flex-shrink-0">
                                <div class="absolute inset-0 bg-primary-500/20 rounded-full blur-2xl opacity-40 group-hover:opacity-100 transition-opacity duration-500"></div>
                                <x-application-logo class="relative w-full h-full fill-current text-white drop-shadow-[0_0_15px_rgba(255,255,255,0.3)] transform group-hover:scale-110 transition-transform duration-500" />
                            </div>
                            <div class="flex flex-col">
                                ...
                                <span class="text-[10px] text-primary-400 font-bold tracking-[0.2em] mt-2 uppercase opacity-80">Education Platform</span>
                            </div>
                        </div>
                        <p class="text-gray-400 leading-relaxed">
                            Platform edukasi terlengkap untuk memahami ekosistem Fintech di Indonesia. Belajar aman, cerdas, dan menyenangkan.
                        </p>
                    </div>
                    <div>
                        <h4 class="text-lg font-bold mb-6">Tautan Cepat</h4>
                        <ul class="space-y-4 text-gray-400">
                            <li><a href="#top" class="hover:text-primary-400 transition-colors flex items-center group/link">
                                Beranda
                                <svg class="w-3 h-3 ml-2 opacity-0 -translate-y-1 group-hover/link:opacity-100 group-hover/link:translate-y-0 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 15l7-7 7 7"></path></svg>
                            </a></li>
                            <li><a href="#about" class="hover:text-primary-400 transition-colors">Tentang Kami</a></li>
                            <li><a href="/modules" class="hover:text-primary-400 transition-colors">Modul Belajar</a></li>
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-gray-400">
                            <li><a href="/leaderboard" class="hover:text-primary-400 transition-colors">Leaderboard</a></li>
                            <li><a href="/login" class="hover:text-primary-400 transition-colors">Masuk Siswa</a></li>
                            <li><a href="/register" class="hover:text-primary-400 transition-colors">Daftar Akun</a></li>
                        </ul>
                    </div>
                </div>
